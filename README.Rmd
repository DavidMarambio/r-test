...
Launch the [`make.R`](https://github.com/DavidMarambio/r-test/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/DavidMarambio/r-test/blob/main/CONTRIBUTING.md).
